...
- (IBAction)btnPayPressed:(id)sender {
    ...
    NSString *amount = [NSString stringWithUTF8String:stProducts[self.row].prodPrice];
    
    // Amount, currency, and description
    payment.amount = [[NSDecimalNumber alloc] initWithString:amount];
    payment.currencyCode = @"MXN";
    payment.shortDescription = [NSString stringWithUTF8String:stProducts[self.row].prodName];
